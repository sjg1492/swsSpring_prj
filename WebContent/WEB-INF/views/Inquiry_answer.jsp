...
th{ height:50px; text-align: center;font-size: 18px;font-weight: bold;}

p,a{color: black;}


#content{margin-left: 120px;}
.tab_title{font-size: 16px;width:100px;}


/* 글쓰기버튼 */
#btn_wrap{text-align: right;padding-top: 20px;padding-right: 175px;}
...
<div id="section" >
	<p style="font-size:27px;font-weight:bold;margin-top: 60px;margin-left: 50px;letter-spacing:3px;">문의 내역 > 문의글 답변</p>

	<div id="content">
		<div id="inquiry_wrap">
		<table id="inquiry_answer_table">
			<tr>
				<td class="tab_title">제목</td>
				<td  ><label>제목불러오기</label></td>
			</tr>
			<tr>
				<td class="tab_title">작성자</td>
				<td  ><label>작성자불러오기</label></td>
			</tr>
			<tr>
				<td align="center">작성 날짜</td>
				<td  ><label>2018-</label></td>
			</tr>
			<tr>
				<td align="center">답변 날짜</td>
				<td  ><label>2018-</label></td>
			</tr>
			<tr class="tab_title">
				<td  >문의 종류</td>
			...
			<tr>
				<td colspan="2">
				<textarea id="inquiry_content">내용을 입력해주세요</textarea></td>
				</tr>
			<tr>
				<th>답변 내용</th>
			</tr>
			<tr>
				<td colspan="2">
				<textarea id="answer_content">내용을 입력해주세요</textarea></td>
			</tr>
		</table>
	</div>
</div>	
...
<!-- 버튼 -->
<div id="btn_wrap" >
 <input type="button" value="뒤로가기" class="btn" id="btn_back" name="btn_back" />
</div>
