...
<div id="section" >
	<p style="font-size:40px;font-weight:bold;margin-top: 60px;margin-left: 50px;letter-spacing:3px;">문의내역</p>
...
<div style="padding-right: 100px;">
 <input id="btn" name="btn" type="button" value="글쓰기" onclick="alert('Hello World')"/>
</div>
